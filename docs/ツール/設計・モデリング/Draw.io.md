...
Draw.io（現在はdiagrams.netとしても知られる）は、完全無料のオープンソース図作成ツールです。ビジネスプロセス図、UML図、ER図、ワイヤーフレーム、ネットワーク図など、様々な図表の作成に対応しています。ブラウザ版とデスクトップ版の両方が利用可能です。
